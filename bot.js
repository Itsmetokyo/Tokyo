...
// Sql
const WhatsAsenaDB = config.DATABASE.define('WhatsMeenu', {
    info: {
...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp... Please wait.')}`);
    ...
    conn.on('open', async () => {
        console.log(
            chalk.green.bold('WA connection successful!✅️')
        );
        console.log(
        ...
        console.log(
            chalk.green.bold('WhatsMeenu is running👧🏻')
        );
    });
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~♥️🕊️______ Meenakshi _____🕊️♥️~*' +
                                    '\n\n*🧞‍♂️ ' + error + '*\n\n Contact Developer : wa. me/916235989299'
                                    , MessageType.text);
                            }
                            if (error.message.includes('URL')) {
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ HATA ÇÖZÜMLEME [♥️🕊️______ Meenakshi _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                        '*\n\n Contact Developer : wa. me/916235989299' +
                                    ...
                                    return await WhatsAsenaCN.sendMessage(WhatsAsenaCN.user.jid, '*⚕️ ERROR ANALYSIS [♥️🕊️______ Meenakshi _____🕊️♥️] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
                                        '*\n\n Contact Developer : wa. me/916235989299' +
